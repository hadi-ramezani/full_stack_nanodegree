...
CLIENT_ID = json.loads(open('/var/www/server_configuration/item_catalog/client_secrets.json', 'r').
                       read())['web']['client_id']
...
def gconnect():
    ...
    try:
        ...
        oauth_flow = flow_from_clientsecrets('/var/www/server_configuration/item_catalog/client_secrets.json', scope='')
